...
namespace CRUDMahasiswaADO
{
    public partial class Form1 : Form
    {
        ...
        private readonly string connectionString = "Data Source=MSI\\BAGAS;Initial Catalog=DBAkademikADO;Integrated Security=True";
        public Form1()
        {
            InitializeComponent();
        ...
        private void btnInsert_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                SqlCommand cmdLog = new SqlCommand(@"INSERT INTO LogAktivitasSalah
                                                        (aktivitas, waktu)
                                                        VALUES
                                                        (@aktivitas, GETDATE())",
                                                    conn,
